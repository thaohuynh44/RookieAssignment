...
namespace RookieAssignment.Backend.Migrations
{
    ...
    [Migration("20210709030829_init_identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RookieAssignment.Backend.Models.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RookieAssignment.Backend.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RookieAssignment.Backend.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RookieAssignment.Backend.Models.MenuItemComment", b =>
                {
                    b.HasOne("RookieAssignment.Backend.Models.MenuItem", "MenuItem")
